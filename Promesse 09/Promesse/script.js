...
/*
    Mais JS peut gérer de la programation asynchrone.
...
/*
    Dans cet objet "promise" on a trois méthodes principales.
        .then() qui va prendre une fonction callback qui sera appelé une fois la promesse tenue (réussi).
...
/*
    ...
    à laquelle on donnera un tableau de toute les promesses que l'on souhaite résoudre.
...
Promise.all([r1, r2]).then(res =>{
    ...
    res.forEach(r =>{
        //  je traite chaque réponse comme je le ferai sur un fetch classique.
        if(r.ok){
...
/*
    ...
    Mais à la diffrérence de ".all()" elles ne rendront que la plus rapide à s'executer.
...
/*
    ...
    Ces arguments représentent à leurs tour deux fonctions callback.
